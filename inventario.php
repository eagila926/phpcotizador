...
foreach ($listActivos as $activo) {
    ...
    $inventarioHtml .= '<tr>';
    $inventarioHtml .= '<td><button type="button" class="btn btn-primary editar-activo" data-assetid="' . $activo['cod_inven'] . '"><i class="fa fa-edit fa-fw" title="Editar"></i></button></td>';
